 ...
 *
 */
public class VisitorImplTemplate {
	public VisitorImplTemplate(Model model, Context context, PrintWriter out) {
		this.model = model;
	...
	public void generate() {
		...
		out.println();
		out.println("public class "+context.getNaming().getVisitorClass(modelName)+" {");
		// Add default factory
		if (context.isGenerateFactory()) {
			...
			out.println(indent+indent+"return host;");
			out.println(indent+"}");
		}
