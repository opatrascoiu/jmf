...
import uk.ac.kent.cs.kmf.templates.java.ClassFactoryVisitorInterfTemplate;
import uk.ac.kent.cs.kmf.util.*;

public class ClassFactoryVisitorGenerator implements Runnable {
	/**
	  * Class members
	  */
	...
	/**
	  ...
	  */
    public ClassFactoryVisitorGenerator(Package pkg, Context context, Classifier cls, File interfDir, File implDir, ILog log) {
    	this.pkg = pkg;
    	...
    	this.cls = cls;
	    visitorInterfaceName = context.getNaming().getFactoryVisitorInterfaceName(cls);
	...
	protected void createClassVisitorInterface(File dir) {
	    ...
	    (new ClassFactoryVisitorInterfTemplate(cls, context, factory)).generate();
	}
}
