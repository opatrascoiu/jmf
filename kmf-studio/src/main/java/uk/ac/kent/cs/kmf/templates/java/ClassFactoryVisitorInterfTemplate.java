 ...
 *
 */
public class ClassFactoryVisitorInterfTemplate {
	public ClassFactoryVisitorInterfTemplate(Classifier cls, Context context, PrintWriter out) {
		this.cls = cls;
	...
	public void generate() {
		...
		out.println();
		out.println(indent+"/** Visit '"+context.getNaming().getFullFactoryInterfaceName(cls)+"' */");
