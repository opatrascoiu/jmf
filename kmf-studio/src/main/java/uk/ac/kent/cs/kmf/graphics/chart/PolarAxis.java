...
/**
 * A special form of axis used for creating Polar charts.  These charts
 *	distribute Y values around a PolarAxis.  By default, the Axis creates
...
public class PolarAxis extends Axis implements AxisInterface {
	...
	double interval, centerX, centerY;
