/**
 *
 *  Class TypeExpression$Class.java
 *
...
public class TypeExpression$Class
extends
	Expression$Class
implements
	TypeExpression,
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public TypeExpression$Class(Name language, String body) {
		//--- Set property 'language' from 'Expression' ---
	...
	public String toString() {
		String strId = "uml.Foundation.Data_Types.TypeExpression";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		TypeExpression$Class obj = new TypeExpression$Class();
