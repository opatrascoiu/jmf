/**
 *
 *  Class UmlInvokeMethod$Class.java
 *
	 ...
	 extends JInternalFrame
{
	...
	/** Construct invoker */
	public UmlInvokeMethod$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.repository.UmlRepository rep, uk.ac.ukc.cs.kmf.kmfstudio.uml.repository.UmlBrowser$Class brow, Object instance, Method method) {
		//--- Init members ---
		this.brow = brow;
		this.rep = rep;
		...
		if (types.length != 0) {
			...
			//--- Preferred sizes ---
			Dimension listSize = uk.ac.ukc.cs.kmf.kmfstudio.uml.repository.UmlBrowser$Class.listSize;
			Dimension fieldSize = uk.ac.ukc.cs.kmf.kmfstudio.uml.repository.UmlBrowser$Class.fieldSize;
			...
			for(int i=0; i<types.length; i++) {
				...
				if (typeName.endsWith("Boolean") || typeName.endsWith("Integer") || typeName.endsWith("Real") || 
					...
					values[i].setFont(uk.ac.ukc.cs.kmf.kmfstudio.uml.repository.UmlBrowser$Class.font);
