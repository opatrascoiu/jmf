/**
 *
 *  Class DataType$Factory$Class.java
 *
...
public class DataType$Factory$Class
	extends UmlFactory$Class
	implements DataType$Factory
{
	/** Default factory constructor */
	public DataType$Factory$Class() {
	}
	public DataType$Factory$Class(UmlRepository repository) {
	...
	/** Accept 'uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.DataType$Visitor' */
