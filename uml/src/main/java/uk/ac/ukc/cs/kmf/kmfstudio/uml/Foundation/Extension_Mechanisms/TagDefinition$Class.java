/**
 *
 *  Class TagDefinition$Class.java
 *
...
public class TagDefinition$Class
extends
    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public TagDefinition$Class() {
		...
		//--- Set property 'tagType' from 'TagDefinition' ---
		this.tagType = null;
		//--- Set property 'multiplicity' from 'TagDefinition' ---
		this.multiplicity = null;
		//--- Set property 'typedValue' from 'TagDefinition' ---
		this.typedValue = new java.util.LinkedHashSet();
		//--- Set property 'owner' from 'TagDefinition' ---
		this.owner = null;
	}
	/** Specialized constructor */
	public TagDefinition$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name tagType, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Multiplicity multiplicity) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'tagType' from 'TagDefinition' */
	protected uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name tagType;
	/** Get property 'tagType' from 'TagDefinition' */
	...
	/** Property 'typedValue' from 'TagDefinition' */
	protected java.util.Set typedValue;
	/** Get property 'typedValue' from 'TagDefinition' */
	...
	/** Property 'owner' from 'TagDefinition' */
	protected Stereotype owner;
	/** Get property 'owner' from 'TagDefinition' */
	...
	public String toString() {
		String strId = "uml.Foundation.Extension_Mechanisms.TagDefinition";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator typedValueIt = this.typedValue.iterator();
		while (typedValueIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Extension_Mechanisms.TaggedValue typedValueObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Extension_Mechanisms.TaggedValue)typedValueIt.next();
			if (typedValueObj != null)
				typedValueObj.setType(null);
		}
		if (owner != null)
			this.owner.getDefinedTag().remove(this);
	}

	/** Clone the object */
	public Object clone() {
		TagDefinition$Class obj = new TagDefinition$Class();
		...
		obj.tagType = tagType==null ? null : (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name)this.tagType.clone();
		...
		obj.typedValue = typedValue==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.typedValue).clone();
