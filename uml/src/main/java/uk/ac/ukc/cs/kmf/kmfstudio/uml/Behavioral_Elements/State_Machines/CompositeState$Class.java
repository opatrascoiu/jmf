/**
 *
 *  Class CompositeState$Class.java
 *
...
public class CompositeState$Class
extends
	State$Class
implements
	CompositeState,
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public CompositeState$Class() {
		...
		this.container = null;
		//--- Set property 'internal_' from 'State' ---
		this.internal_ = new java.util.LinkedHashSet();
		//--- Set property 'stateMachine' from 'State' ---
		this.stateMachine = null;
		//--- Set property 'entry' from 'State' ---
		this.entry = null;
		//--- Set property 'exit' from 'State' ---
		this.exit = null;
		//--- Set property 'subvertex' from 'CompositeState' ---
		this.subvertex = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public CompositeState$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'subvertex' from 'CompositeState' */
	protected java.util.Set subvertex;
	/** Get property 'subvertex' from 'CompositeState' */
	...
	public String toString() {
		String strId = "uml.Behavioral_Elements.State_Machines.CompositeState";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator internal_It = this.internal_.iterator();
		while (internal_It.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.Transition internal_Obj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.Transition)internal_It.next();
			if (internal_Obj != null)
				internal_Obj.setState(null);
		}
		if (stateMachine != null)
			this.stateMachine.setTop(null);
		if (entry != null)
			this.entry.setEntry_state(null);
		if (exit != null)
			this.exit.setExit_state(null);
		java.util.Iterator subvertexIt = this.subvertex.iterator();
		while (subvertexIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.StateVertex subvertexObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.StateVertex)subvertexIt.next();
			if (subvertexObj != null)
				subvertexObj.setContainer(null);
		}
	}

	/** Clone the object */
	public Object clone() {
		CompositeState$Class obj = new CompositeState$Class();
		...
		obj.internal_ = internal_==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.internal_).clone();
		obj.stateMachine = stateMachine==null ? null : this.stateMachine;
		obj.entry = entry==null ? null : this.entry;
		obj.exit = exit==null ? null : this.exit;
		obj.subvertex = subvertex==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.subvertex).clone();
		return obj;
	}
