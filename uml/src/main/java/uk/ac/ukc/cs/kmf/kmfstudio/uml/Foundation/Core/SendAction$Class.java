    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public SendAction$Class() {
		...
		//--- Set property 'signal' from 'SendAction' ---
		this.signal = null;
	}
	/** Specialized constructor */
	public SendAction$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'signal' from 'SendAction' */
	protected Signal signal;
	/** Get property 'signal' from 'SendAction' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.SendAction";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (signal != null)
			this.signal.getSendAction().remove(this);
	}

	/** Clone the object */
	public Object clone() {
		SendAction$Class obj = new SendAction$Class();
		...
		obj.signal = signal==null ? null : this.signal;
		return obj;
	}
