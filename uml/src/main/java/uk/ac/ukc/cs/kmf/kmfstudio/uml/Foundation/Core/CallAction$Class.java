    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public CallAction$Class() {
		...
		//--- Set property 'operation' from 'CallAction' ---
		this.operation = null;
	}
	/** Specialized constructor */
	public CallAction$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'operation' from 'CallAction' */
	protected Operation operation;
	/** Get property 'operation' from 'CallAction' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.CallAction";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (operation != null)
			this.operation.getCallAction().remove(this);
	}

	/** Clone the object */
	public Object clone() {
		CallAction$Class obj = new CallAction$Class();
