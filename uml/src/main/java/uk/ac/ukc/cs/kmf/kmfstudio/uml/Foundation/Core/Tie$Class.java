    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Tie$Class() {
		...
		//--- Set property 'tiedElement' from 'Tie' ---
		this.tiedElement = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Tie$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'tiedElement' from 'Tie' */
	protected java.util.Set tiedElement;
	/** Get property 'tiedElement' from 'Tie' */
	public java.util.Set getTiedElement() {
		return tiedElement;
	}
	/** Set property 'tiedElement' from 'Tie' */
	public void setTiedElement(java.util.Set tiedElement) { 
		this.tiedElement = tiedElement;
	}
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Tie";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator tiedElementIt = this.tiedElement.iterator();
		while (tiedElementIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement tiedElementObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement)tiedElementIt.next();
			tiedElementObj.getTie().remove(this);
			tiedElementObj.getTie().remove(this);
		}
	}
	...
	public Object clone() {
		...
		obj.tiedElement = tiedElement==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.tiedElement).clone();
		return obj;
	}

	/** Accept 'uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.TieVisitor' */
