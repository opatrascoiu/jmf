/**
 *
 *  Class ClassifierFactory$Class.java
 *
...
public class ClassifierFactory$Class
	extends uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlFactory$Class
	implements ClassifierFactory
{
	/** Default factory constructor */
	public ClassifierFactory$Class() {
	}
	public ClassifierFactory$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.repository.UmlRepository repository) {
