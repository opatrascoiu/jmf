/**
 *
 *  Class State$Factory$Class.java
 *
...
public class State$Factory$Class
	extends UmlFactory$Class
	implements State$Factory
{
	/** Default factory constructor */
	public State$Factory$Class() {
	}
	public State$Factory$Class(UmlRepository repository) {
	...
	/** Accept 'uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.State$Visitor' */
