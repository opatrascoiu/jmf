...
public class StateVertex$Class
extends
    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public StateVertex$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'outgoing' from 'StateVertex' */
	protected java.util.Set outgoing;
	/** Get property 'outgoing' from 'StateVertex' */
	...
	/** Property 'incoming' from 'StateVertex' */
	protected java.util.Set incoming;
	/** Get property 'incoming' from 'StateVertex' */
	...
	/** Property 'container' from 'StateVertex' */
	protected CompositeState container;
	/** Get property 'container' from 'StateVertex' */
	...
	public String toString() {
		String strId = "uml.Behavioral_Elements.State_Machines.StateVertex";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		StateVertex$Class obj = new StateVertex$Class();
