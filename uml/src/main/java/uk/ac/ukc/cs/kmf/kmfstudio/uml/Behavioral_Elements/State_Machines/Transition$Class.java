    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Transition$Class() {
		...
		//--- Set property 'stateMachine' from 'Transition' ---
		this.stateMachine = null;
		//--- Set property 'guard' from 'Transition' ---
		this.guard = null;
		//--- Set property 'source' from 'Transition' ---
		this.source = null;
		//--- Set property 'target' from 'Transition' ---
		this.target = null;
		//--- Set property 'state' from 'Transition' ---
		this.state = null;
		//--- Set property 'effect' from 'Transition' ---
		this.effect = null;
		//--- Set property 'trigger' from 'Transition' ---
		this.trigger = null;
	}
	/** Specialized constructor */
	public Transition$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'stateMachine' from 'Transition' */
	protected StateMachine stateMachine;
	/** Get property 'stateMachine' from 'Transition' */
	...
	/** Property 'guard' from 'Transition' */
	protected Guard guard;
	/** Get property 'guard' from 'Transition' */
	...
	/** Property 'source' from 'Transition' */
	protected StateVertex source;
	/** Get property 'source' from 'Transition' */
	...
	/** Property 'target' from 'Transition' */
	protected StateVertex target;
	/** Get property 'target' from 'Transition' */
	...
	/** Property 'state' from 'Transition' */
	protected State state;
	/** Get property 'state' from 'Transition' */
	...
	/** Property 'effect' from 'Transition' */
	protected Action effect;
	/** Get property 'effect' from 'Transition' */
	...
	/** Property 'trigger' from 'Transition' */
	protected Event trigger;
	/** Get property 'trigger' from 'Transition' */
	...
	public String toString() {
		String strId = "uml.Behavioral_Elements.State_Machines.Transition";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (stateMachine != null)
			this.stateMachine.getTransitions().remove(this);
		if (guard != null)
			this.guard.setTransition(null);
		if (source != null)
			this.source.getOutgoing().remove(this);
		if (target != null)
			this.target.getIncoming().remove(this);
		if (state != null)
			this.state.getInternal_().remove(this);
		if (effect != null)
			this.effect.setTransition(null);
		if (trigger != null)
			this.trigger.getTransition().remove(this);
	}
	...
	public Object clone() {
		...
		obj.guard = guard==null ? null : this.guard;
		obj.source = source==null ? null : this.source;
		obj.target = target==null ? null : this.target;
		obj.state = state==null ? null : this.state;
		obj.effect = effect==null ? null : this.effect;
		obj.trigger = trigger==null ? null : this.trigger;
		return obj;
	}
