    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	/** Property 'defaultValue' from 'Parameter' */
	protected uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Expression defaultValue;
	/** Get property 'defaultValue' from 'Parameter' */
	...
	/** Property 'kind' from 'Parameter' */
	protected uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.ParameterDirectionKind kind;
	/** Get property 'kind' from 'Parameter' */
	...
	/** Property 'type' from 'Parameter' */
	protected Classifier type;
	/** Get property 'type' from 'Parameter' */
	...
	/** Property 'behavioralFeature' from 'Parameter' */
	protected BehavioralFeature behavioralFeature;
	/** Get property 'behavioralFeature' from 'Parameter' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Parameter";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (type != null)
			this.type.getTypedParameter().remove(this);
		if (behavioralFeature != null)
			this.behavioralFeature.getParameter().remove(this);
	}

	/** Clone the object */
	public Object clone() {
		Parameter$Class obj = new Parameter$Class();
		...
		obj.defaultValue = defaultValue==null ? null : (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Expression)this.defaultValue.clone();
		obj.kind = kind==null ? null : (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.ParameterDirectionKind)this.kind.clone();
		obj.type = type==null ? null : this.type;
		obj.behavioralFeature = behavioralFeature==null ? null : this.behavioralFeature;
		return obj;
	}
