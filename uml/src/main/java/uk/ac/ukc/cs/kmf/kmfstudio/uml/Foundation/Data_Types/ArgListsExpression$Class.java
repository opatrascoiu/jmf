/**
 *
 *  Class ArgListsExpression$Class.java
 *
...
public class ArgListsExpression$Class
extends
	Expression$Class
implements
	ArgListsExpression,
...
{
	/** Default constructor */
	public ArgListsExpression$Class() {
	...
	public ArgListsExpression$Class(Name language, String body) {
		//--- Set property 'language' from 'Expression' ---
	...
	public String toString() {
		String strId = "uml.Foundation.Data_Types.ArgListsExpression";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		ArgListsExpression$Class obj = new ArgListsExpression$Class();
