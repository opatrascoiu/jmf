/**
 *
 *  Class MappingExpression$Class.java
 *
...
public class MappingExpression$Class
extends
	Expression$Class
implements
	MappingExpression,
...
{
	/** Default constructor */
	public MappingExpression$Class() {
	...
	public MappingExpression$Class(Name language, String body) {
		//--- Set property 'language' from 'Expression' ---
	...
	public String toString() {
		String strId = "uml.Foundation.Data_Types.MappingExpression";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		MappingExpression$Class obj = new MappingExpression$Class();
