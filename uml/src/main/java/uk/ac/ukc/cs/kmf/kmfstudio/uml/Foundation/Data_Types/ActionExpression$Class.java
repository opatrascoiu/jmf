/**
 *
 *  Class ActionExpression$Class.java
 *
...
public class ActionExpression$Class
extends
	Expression$Class
implements
	ActionExpression,
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public ActionExpression$Class(Name language, String body) {
		//--- Set property 'language' from 'Expression' ---
	...
	public String toString() {
		String strId = "uml.Foundation.Data_Types.ActionExpression";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		ActionExpression$Class obj = new ActionExpression$Class();
