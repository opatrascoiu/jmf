    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Node$Class() {
		...
		//--- Set property 'resident' from 'Node' ---
		this.resident = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Node$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification, Boolean isRoot, Boolean isLeaf, Boolean isAbstract) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'resident' from 'Node' */
	protected java.util.Set resident;
	/** Get property 'resident' from 'Node' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Node";
		String name = null;
		try {
	...
	public void delete() {
		...
		while (residentIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.Component residentObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.Component)residentIt.next();
			residentObj.getDeploymentLocation().remove(this);
			residentObj.getDeploymentLocation().remove(this);
		}
	}
