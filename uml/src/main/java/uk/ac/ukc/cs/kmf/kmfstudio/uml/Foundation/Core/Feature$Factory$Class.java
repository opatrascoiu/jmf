/**
 *
 *  Class Feature$Factory$Class.java
 *
...
public class Feature$Factory$Class
	extends UmlFactory$Class
	implements Feature$Factory
{
	/** Default factory constructor */
	public Feature$Factory$Class() {
	}
	public Feature$Factory$Class(UmlRepository repository) {
	...
	/** Accept 'uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.Feature$Visitor' */
