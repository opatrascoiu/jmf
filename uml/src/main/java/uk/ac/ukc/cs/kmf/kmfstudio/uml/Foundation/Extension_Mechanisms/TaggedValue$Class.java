...
public class TaggedValue$Class
extends
	uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement$Class
implements
	TaggedValue,
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	/** Default constructor */
	public TaggedValue$Class() {
		...
		//--- Set property 'dataValue' from 'TaggedValue' ---
		this.dataValue = new String();
		//--- Set property 'tag' from 'TaggedValue' ---
		this.tag = null;
		//--- Set property 'value' from 'TaggedValue' ---
		this.value = new String();
		//--- Set property 'modelElement' from 'TaggedValue' ---
		this.modelElement = null;
		//--- Set property 'referenceValue' from 'TaggedValue' ---
		this.referenceValue = new java.util.LinkedHashSet();
		//--- Set property 'type' from 'TaggedValue' ---
		this.type = null;
	}
	/** Specialized constructor */
	public TaggedValue$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification, String dataValue, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name tag, String value) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'dataValue' from 'TaggedValue' */
	protected String dataValue;
	/** Get property 'dataValue' from 'TaggedValue' */
	...
	/** Property 'tag' from 'TaggedValue' */
	protected uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name tag;
	/** Get property 'tag' from 'TaggedValue' */
	...
	/** Property 'modelElement' from 'TaggedValue' */
	protected uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement modelElement;
	/** Get property 'modelElement' from 'TaggedValue' */
	...
	/** Property 'referenceValue' from 'TaggedValue' */
	protected java.util.Set referenceValue;
	/** Get property 'referenceValue' from 'TaggedValue' */
	...
	/** Property 'type' from 'TaggedValue' */
	protected TagDefinition type;
	/** Get property 'type' from 'TaggedValue' */
	...
	public String toString() {
		String strId = "uml.Foundation.Extension_Mechanisms.TaggedValue";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (modelElement != null)
			this.modelElement.getTaggedValue().remove(this);
		java.util.Iterator referenceValueIt = this.referenceValue.iterator();
		while (referenceValueIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement referenceValueObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement)referenceValueIt.next();
			referenceValueObj.getReferenceTag().remove(this);
			referenceValueObj.getReferenceTag().remove(this);
		}
		if (type != null)
			this.type.getTypedValue().remove(this);
	}

	/** Clone the object */
	public Object clone() {
		TaggedValue$Class obj = new TaggedValue$Class();
		...
		obj.dataValue = dataValue==null ? null : this.dataValue;
		obj.tag = tag==null ? null : (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name)this.tag.clone();
		obj.value = value==null ? null : this.value;
		obj.modelElement = modelElement==null ? null : this.modelElement;
		obj.referenceValue = referenceValue==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.referenceValue).clone();
