    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Binding$Class() {
		...
		//--- Set property 'argument' from 'Binding' ---
		this.argument = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Binding$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'argument' from 'Binding' */
	protected java.util.Set argument;
	/** Get property 'argument' from 'Binding' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Binding";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator argumentIt = this.argument.iterator();
		while (argumentIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement argumentObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement)argumentIt.next();
			if (argumentObj != null)
				argumentObj.setBinding(null);
		}
	}
	...
	public Object clone() {
		...
		obj.argument = argument==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.argument).clone();
		return obj;
	}
