/**
 *
 *  Class IterationExpression$Class.java
 *
...
public class IterationExpression$Class
extends
	Expression$Class
implements
	IterationExpression,
...
{
	/** Default constructor */
	public IterationExpression$Class() {
	...
	public IterationExpression$Class(Name language, String body) {
		//--- Set property 'language' from 'Expression' ---
	...
	public String toString() {
		String strId = "uml.Foundation.Data_Types.IterationExpression";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		IterationExpression$Class obj = new IterationExpression$Class();
