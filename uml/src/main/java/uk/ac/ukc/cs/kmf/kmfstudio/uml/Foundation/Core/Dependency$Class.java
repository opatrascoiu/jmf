    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Dependency$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'client' from 'Dependency' */
	protected java.util.Set client;
	/** Get property 'client' from 'Dependency' */
	...
	/** Property 'supplier' from 'Dependency' */
	protected java.util.Set supplier;
	/** Get property 'supplier' from 'Dependency' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Dependency";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		Dependency$Class obj = new Dependency$Class();
