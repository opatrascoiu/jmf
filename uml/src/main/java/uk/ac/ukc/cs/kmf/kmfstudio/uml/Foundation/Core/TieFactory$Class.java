...
public class TieFactory$Class
	extends uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlFactory$Class
	implements TieFactory
{
	/** Default factory constructor */
	public TieFactory$Class() {
	}
	public TieFactory$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.repository.UmlRepository repository) {
