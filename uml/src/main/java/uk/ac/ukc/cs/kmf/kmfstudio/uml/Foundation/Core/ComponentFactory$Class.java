/**
 *
 *  Class ComponentFactory$Class.java
 *
...
public class ComponentFactory$Class
	extends uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlFactory$Class
	implements ComponentFactory
{
	/** Default factory constructor */
	public ComponentFactory$Class() {
	}
	public ComponentFactory$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.repository.UmlRepository repository) {
