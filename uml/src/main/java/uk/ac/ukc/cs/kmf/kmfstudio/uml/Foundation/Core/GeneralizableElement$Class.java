/**
 *
 *  Class GeneralizableElement$Class.java
 *
...
public class GeneralizableElement$Class
extends
	ModelElement$Class
implements
...
{
	/** Default constructor */
	public GeneralizableElement$Class() {
	...
	public GeneralizableElement$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification, Boolean isRoot, Boolean isLeaf, Boolean isAbstract) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	public String toString() {
		String strId = "uml.Foundation.Core.GeneralizableElement";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		GeneralizableElement$Class obj = new GeneralizableElement$Class();
