...
public class StateMachine$Class
extends
    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public StateMachine$Class() {
		...
		//--- Set property 'context' from 'StateMachine' ---
		this.context = null;
		//--- Set property 'transitions' from 'StateMachine' ---
		this.transitions = new java.util.LinkedHashSet();
		//--- Set property 'top' from 'StateMachine' ---
		this.top = null;
	}
	/** Specialized constructor */
	public StateMachine$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'context' from 'StateMachine' */
	protected uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement context;
	/** Get property 'context' from 'StateMachine' */
	...
	/** Property 'transitions' from 'StateMachine' */
	protected java.util.Set transitions;
	/** Get property 'transitions' from 'StateMachine' */
	...
	/** Property 'top' from 'StateMachine' */
	protected State top;
	/** Get property 'top' from 'StateMachine' */
	public State getTop() {
		return top;
	}
	/** Set property 'top' from 'StateMachine' */
	...
	public String toString() {
		String strId = "uml.Behavioral_Elements.State_Machines.StateMachine";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (context != null)
			this.context.getBehavior().remove(this);
		java.util.Iterator transitionsIt = this.transitions.iterator();
		while (transitionsIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.Transition transitionsObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.Transition)transitionsIt.next();
			if (transitionsObj != null)
				transitionsObj.setStateMachine(null);
		}
		if (top != null)
			this.top.setStateMachine(null);
	}

	/** Clone the object */
	public Object clone() {
		StateMachine$Class obj = new StateMachine$Class();
		...
		obj.transitions = transitions==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.transitions).clone();
		obj.top = top==null ? null : this.top;
		return obj;
	}
