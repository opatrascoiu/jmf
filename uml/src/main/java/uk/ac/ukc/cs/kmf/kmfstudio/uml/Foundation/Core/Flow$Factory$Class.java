...
public class Flow$Factory$Class
	extends UmlFactory$Class
	implements Flow$Factory
{
	/** Default factory constructor */
	public Flow$Factory$Class() {
	}
	public Flow$Factory$Class(UmlRepository repository) {
	...
	/** Accept 'uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.Flow$Visitor' */
