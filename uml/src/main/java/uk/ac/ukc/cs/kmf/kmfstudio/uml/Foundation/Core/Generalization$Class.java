/**
 *
 *  Class Generalization$Class.java
 *
...
public class Generalization$Class
extends
	Relationship$Class
implements
	Generalization,
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Generalization$Class() {
		...
		//--- Set property 'discriminator' from 'Generalization' ---
		this.discriminator = null;
		//--- Set property 'child' from 'Generalization' ---
		this.child = null;
		//--- Set property 'parent' from 'Generalization' ---
		this.parent = null;
	}
	/** Specialized constructor */
	public Generalization$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name discriminator) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'discriminator' from 'Generalization' */
	protected uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name discriminator;
	/** Get property 'discriminator' from 'Generalization' */
	...
	/** Property 'child' from 'Generalization' */
	protected GeneralizableElement child;
	/** Get property 'child' from 'Generalization' */
	...
	/** Property 'parent' from 'Generalization' */
	protected GeneralizableElement parent;
	/** Get property 'parent' from 'Generalization' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Generalization";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (child != null)
			this.child.getGeneralization().remove(this);
		if (parent != null)
			this.parent.getSpecialization().remove(this);
	}

	/** Clone the object */
	public Object clone() {
		Generalization$Class obj = new Generalization$Class();
		...
		obj.discriminator = discriminator==null ? null : (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name)this.discriminator.clone();
