/**
 *
 *  Class PrimitiveFactory$Class.java
 *
...
public class PrimitiveFactory$Class
	extends uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlFactory$Class
	implements PrimitiveFactory
{
	/** Default factory constructor */
	public PrimitiveFactory$Class() {
	}
	public PrimitiveFactory$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.repository.UmlRepository repository) {
	...
	/** Accept 'uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.PrimitiveVisitor' */
