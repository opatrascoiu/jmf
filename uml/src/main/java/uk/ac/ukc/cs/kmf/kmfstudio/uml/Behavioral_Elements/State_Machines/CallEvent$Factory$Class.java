/**
 *
 *  Class CallEvent$Factory$Class.java
 *
...
public class CallEvent$Factory$Class
	extends UmlFactory$Class
	implements CallEvent$Factory
{
	/** Default factory constructor */
	public CallEvent$Factory$Class() {
	}
	public CallEvent$Factory$Class(UmlRepository repository) {
	...
	public String toString() {
		return "CallEvent_Factory";
	}

	/** Accept 'uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.CallEvent$Visitor' */
