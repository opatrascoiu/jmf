/**
 *
 *  Class ProcedureExpression$Class.java
 *
...
public class ProcedureExpression$Class
extends
	Expression$Class
implements
	ProcedureExpression,
...
{
	/** Default constructor */
	public ProcedureExpression$Class() {
	...
	public ProcedureExpression$Class(Name language, String body) {
		//--- Set property 'language' from 'Expression' ---
	...
	public String toString() {
		String strId = "uml.Foundation.Data_Types.ProcedureExpression";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		ProcedureExpression$Class obj = new ProcedureExpression$Class();
