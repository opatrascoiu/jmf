    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Signal$Class() {
		...
		//--- Set property 'sendAction' from 'Signal' ---
		this.sendAction = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Signal$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'sendAction' from 'Signal' */
	protected java.util.Set sendAction;
	/** Get property 'sendAction' from 'Signal' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Signal";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator sendActionIt = this.sendAction.iterator();
		while (sendActionIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.SendAction sendActionObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.SendAction)sendActionIt.next();
			if (sendActionObj != null)
				sendActionObj.setSignal(null);
		}
	}

	/** Clone the object */
	public Object clone() {
		Signal$Class obj = new Signal$Class();
		...
		obj.sendAction = sendAction==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.sendAction).clone();
		return obj;
	}
