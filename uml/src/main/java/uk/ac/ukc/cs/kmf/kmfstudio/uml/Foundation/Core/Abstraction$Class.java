...
public class Abstraction$Class
extends
	Dependency$Class
implements
	Abstraction,
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Abstraction$Class() {
		...
		//--- Set property 'client' from 'Dependency' ---
		this.client = new java.util.LinkedHashSet();
		//--- Set property 'supplier' from 'Dependency' ---
		this.supplier = new java.util.LinkedHashSet();
		//--- Set property 'mapping' from 'Abstraction' ---
		this.mapping = null;
	}
	/** Specialized constructor */
	public Abstraction$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.MappingExpression mapping) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'mapping' from 'Abstraction' */
	protected uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.MappingExpression mapping;
	/** Get property 'mapping' from 'Abstraction' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Abstraction";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator clientIt = this.client.iterator();
		while (clientIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement clientObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement)clientIt.next();
			clientObj.getClientDependency().remove(this);
			clientObj.getClientDependency().remove(this);
		}
		java.util.Iterator supplierIt = this.supplier.iterator();
		while (supplierIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement supplierObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement)supplierIt.next();
			supplierObj.getSupplierDependency().remove(this);
			supplierObj.getSupplierDependency().remove(this);
		}
	}
	...
	/** Clone the object */
	public Object clone() {
		Abstraction$Class obj = new Abstraction$Class();
		...
		obj.client = client==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.client).clone();
		obj.supplier = supplier==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.supplier).clone();
		obj.mapping = mapping==null ? null : (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.MappingExpression)this.mapping.clone();
		return obj;
	}
