/**
 *
 *  Class Element$Factory$Class.java
 *
...
public class Element$Factory$Class
	extends UmlFactory$Class
	implements Element$Factory
{
	/** Default factory constructor */
	public Element$Factory$Class() {
	}
	public Element$Factory$Class(UmlRepository repository) {
	...
	/** Accept 'uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.Element$Visitor' */
