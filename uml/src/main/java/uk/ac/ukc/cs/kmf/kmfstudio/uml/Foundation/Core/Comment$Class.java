    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Comment$Class() {
		...
		//--- Set property 'annotatedElement' from 'Comment' ---
		this.annotatedElement = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Comment$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'annotatedElement' from 'Comment' */
	protected java.util.Set annotatedElement;
	/** Get property 'annotatedElement' from 'Comment' */
	public java.util.Set getAnnotatedElement() {
		return annotatedElement;
	}
	/** Set property 'annotatedElement' from 'Comment' */
	public void setAnnotatedElement(java.util.Set annotatedElement) { 
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Comment";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator annotatedElementIt = this.annotatedElement.iterator();
		while (annotatedElementIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement annotatedElementObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement)annotatedElementIt.next();
			annotatedElementObj.getComment().remove(this);
			annotatedElementObj.getComment().remove(this);
		}
	}
	...
	/** Clone the object */
	public Object clone() {
		Comment$Class obj = new Comment$Class();
		...
		obj.annotatedElement = annotatedElement==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.annotatedElement).clone();
		return obj;
	}
