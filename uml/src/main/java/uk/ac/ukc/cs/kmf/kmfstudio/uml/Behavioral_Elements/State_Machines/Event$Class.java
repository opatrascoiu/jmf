    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Event$Class() {
		...
		//--- Set property 'transition' from 'Event' ---
		this.transition = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Event$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'transition' from 'Event' */
	protected java.util.Set transition;
	/** Get property 'transition' from 'Event' */
	...
	public String toString() {
		String strId = "uml.Behavioral_Elements.State_Machines.Event";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator transitionIt = this.transition.iterator();
		while (transitionIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.Transition transitionObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.Transition)transitionIt.next();
			if (transitionObj != null)
				transitionObj.setTrigger(null);
		}
	}

	/** Clone the object */
	public Object clone() {
		Event$Class obj = new Event$Class();
		...
		obj.transition = transition==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.transition).clone();
		return obj;
	}
