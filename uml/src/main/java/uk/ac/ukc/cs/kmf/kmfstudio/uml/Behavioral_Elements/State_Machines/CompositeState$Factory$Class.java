/**
 *
 *  Class CompositeState$Factory$Class.java
 *
...
public class CompositeState$Factory$Class
	extends UmlFactory$Class
	implements CompositeState$Factory
{
	/** Default factory constructor */
	public CompositeState$Factory$Class() {
	}
	public CompositeState$Factory$Class(UmlRepository repository) {
	...
	public String toString() {
		return "CompositeState_Factory";
	}

	/** Accept 'uk.ac.ukc.cs.kmf.kmfstudio.uml.Behavioral_Elements.State_Machines.CompositeState$Visitor' */
