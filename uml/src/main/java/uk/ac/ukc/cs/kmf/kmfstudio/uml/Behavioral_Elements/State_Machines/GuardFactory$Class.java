...
public class GuardFactory$Class
	extends uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlFactory$Class
	implements GuardFactory
{
	/** Default factory constructor */
	public GuardFactory$Class() {
	}
	public GuardFactory$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.repository.UmlRepository repository) {
