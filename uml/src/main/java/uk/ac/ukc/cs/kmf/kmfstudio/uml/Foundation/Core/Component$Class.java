    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Component$Class() {
		...
		//--- Set property 'deploymentLocation' from 'Component' ---
		this.deploymentLocation = new java.util.LinkedHashSet();
		//--- Set property 'resident' from 'Component' ---
		this.resident = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Component$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification, Boolean isRoot, Boolean isLeaf, Boolean isAbstract) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'deploymentLocation' from 'Component' */
	protected java.util.Set deploymentLocation;
	/** Get property 'deploymentLocation' from 'Component' */
	...
	/** Property 'resident' from 'Component' */
	protected java.util.Set resident;
	/** Get property 'resident' from 'Component' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Component";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator deploymentLocationIt = this.deploymentLocation.iterator();
		while (deploymentLocationIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.Node deploymentLocationObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.Node)deploymentLocationIt.next();
			deploymentLocationObj.getResident().remove(this);
			deploymentLocationObj.getResident().remove(this);
		}
		java.util.Iterator residentIt = this.resident.iterator();
		while (residentIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement residentObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement)residentIt.next();
			residentObj.getImplementationLocation().remove(this);
			residentObj.getImplementationLocation().remove(this);
		}
	}
	...
	/** Clone the object */
	public Object clone() {
		Component$Class obj = new Component$Class();
		...
		obj.deploymentLocation = deploymentLocation==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.deploymentLocation).clone();
		obj.resident = resident==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.resident).clone();
		return obj;
	}

	/** Accept 'uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ComponentVisitor' */
