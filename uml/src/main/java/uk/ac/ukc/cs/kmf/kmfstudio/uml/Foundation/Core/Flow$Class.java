    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Flow$Class() {
		...
		//--- Set property 'target' from 'Flow' ---
		this.target = new java.util.LinkedHashSet();
		//--- Set property 'source' from 'Flow' ---
		this.source = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Flow$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	/** Property 'target' from 'Flow' */
	protected java.util.Set target;
	/** Get property 'target' from 'Flow' */
	...
	/** Property 'source' from 'Flow' */
	protected java.util.Set source;
	/** Get property 'source' from 'Flow' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Flow";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator targetIt = this.target.iterator();
		while (targetIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement targetObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement)targetIt.next();
			targetObj.getTargetFlow().remove(this);
			targetObj.getTargetFlow().remove(this);
		}
		java.util.Iterator sourceIt = this.source.iterator();
		while (sourceIt.hasNext()) {
			uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement sourceObj = (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Core.ModelElement)sourceIt.next();
			sourceObj.getSourceFlow().remove(this);
			sourceObj.getSourceFlow().remove(this);
		}
	}
	...
	public Object clone() {
		...
		obj.target = target==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.target).clone();
		obj.source = source==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.source).clone();
		return obj;
	}
