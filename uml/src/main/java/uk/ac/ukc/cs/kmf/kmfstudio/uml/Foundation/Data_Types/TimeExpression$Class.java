/**
 *
 *  Class TimeExpression$Class.java
 *
...
public class TimeExpression$Class
extends
	Expression$Class
implements
	TimeExpression,
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public TimeExpression$Class(Name language, String body) {
		//--- Set property 'language' from 'Expression' ---
	...
	public String toString() {
		String strId = "uml.Foundation.Data_Types.TimeExpression";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		TimeExpression$Class obj = new TimeExpression$Class();
