    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	protected uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Expression initialValue;
	...
	/** Property 'associationEnd' from 'Attribute' */
	protected AssociationEnd associationEnd;
	/** Get property 'associationEnd' from 'Attribute' */
	...
	public String toString() {
		String strId = "uml.Foundation.Core.Attribute";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (associationEnd != null)
			this.associationEnd.setQualifier(null);
	}
	...
	public Object clone() {
		...
		obj.initialValue = initialValue==null ? null : (uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Expression)this.initialValue.clone();
