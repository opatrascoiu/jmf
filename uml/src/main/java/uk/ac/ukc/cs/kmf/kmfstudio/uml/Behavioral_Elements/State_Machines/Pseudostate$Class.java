    ...
    uk.ac.ukc.cs.kmf.kmfstudio.uml.UmlVisitable
{
	...
	public Pseudostate$Class(uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.Name name, uk.ac.ukc.cs.kmf.kmfstudio.uml.Foundation.Data_Types.VisibilityKind visibility, Boolean isSpecification, String kind) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'visibility' from 'ModelElement' ---
	...
	public String toString() {
		String strId = "uml.Behavioral_Elements.State_Machines.Pseudostate";
		String name = null;
		try {
	...
	public Object clone() {
		...
		obj.kind = kind==null ? null : this.kind;
		return obj;
	}
