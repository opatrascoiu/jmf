    ...
    YatlVisitable
{
	...
	public WhileStm$Class(Object location) {
		//--- Set property 'location' from 'Statement' ---
	...
	public String toString() {
		String strId = "syntax.statements.WhileStm";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		WhileStm$Class obj = new WhileStm$Class();
	...
	/** Accept 'uk.ac.kent.cs.ktl.syntax.statements.WhileStm$Visitor' */
