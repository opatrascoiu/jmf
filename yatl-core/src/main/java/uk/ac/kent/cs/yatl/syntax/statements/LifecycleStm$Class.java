...
public class LifecycleStm$Class
extends
	Statement$Class
implements
	LifecycleStm,
    YatlVisitable
{
	...
	public LifecycleStm$Class(Object location) {
		//--- Set property 'location' from 'Statement' ---
	...
	public String toString() {
		String strId = "syntax.statements.LifecycleStm";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		LifecycleStm$Class obj = new LifecycleStm$Class();
	...
	/** Accept 'uk.ac.kent.cs.ktl.syntax.statements.LifecycleStm$Visitor' */
