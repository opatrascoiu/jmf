    ...
    YatlVisitable
{
	...
	public LoopStm$Class(Object location) {
		//--- Set property 'location' from 'Statement' ---
	...
	/** Property 'body' from 'LoopStm' */
	protected Statement body;
	/** Get property 'body' from 'LoopStm' */
	...
	/** Property 'expression' from 'LoopStm' */
	protected Object expression;
	/** Get property 'expression' from 'LoopStm' */
	...
	public String toString() {
		String strId = "syntax.statements.LoopStm";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		LoopStm$Class obj = new LoopStm$Class();
	...
	/** Accept 'uk.ac.kent.cs.ktl.syntax.statements.LoopStm$Visitor' */
