...
public class Invariants {
	public static class Library {
		...
		public static Object inv$1(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t1 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// return result
		...
		public static Object inv$2(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t3 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'size'
		...
		public static Object inv$3(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t6 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'size'
		...
		public static Object inv$4(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t9 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
		...
		public static Object inv$5(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t13 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
		...
		public static Object inv$6(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t17 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
		...
		public static Object inv$7(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t22 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
		...
		public static Object inv$8(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t26 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
		...
		public static Object inv$9(library.Library self) {
			try {
				// return result
				if (library.BookCategory$Class.ScienceFiction != null) return library.BookCategory$Class.ScienceFiction;
				else return StdLibAdapterImpl.INSTANCE.Undefined();
			} catch (Exception e) {
				return StdLibAdapterImpl.INSTANCE.Undefined();
			}
		...
		public static Object inv$10(library.Library self) {
			try {
				// return result
				if (library.BookCategory$Class.Biography != null) return library.BookCategory$Class.Biography;
				else return StdLibAdapterImpl.INSTANCE.Undefined();
			} catch (Exception e) {
				return StdLibAdapterImpl.INSTANCE.Undefined();
			}
		...
		public static Object inv$11(library.Library self) {
			try {
				...
				OclBoolean t27 = StdLibAdapterImpl.INSTANCE.Boolean(KmfImplementationAdapterImpl.INSTANCE.EnumLiteral_equalTo(library.BookCategory$Class.ScienceFiction, library.BookCategory$Class.ScienceFiction));
				// return result
		...
		public static Object inv$12(library.Library self) {
			try {
				// Call operation 'equalTo'
				OclBoolean t28 = StdLibAdapterImpl.INSTANCE.Boolean(KmfImplementationAdapterImpl.INSTANCE.EnumLiteral_equalTo(library.BookCategory$Class.ScienceFiction, library.BookCategory$Class.Biography));
				// return result
		...
		public static Object inv$13(library.Library self) {
			try {
				...
				OclBoolean t29 = StdLibAdapterImpl.INSTANCE.Boolean(!KmfImplementationAdapterImpl.INSTANCE.EnumLiteral_equalTo(library.BookCategory$Class.ScienceFiction, library.BookCategory$Class.ScienceFiction));
				// return result
		...
		public static Object inv$14(library.Library self) {
			try {
				// Call operation 'notEqualTo'
				OclBoolean t30 = StdLibAdapterImpl.INSTANCE.Boolean(!KmfImplementationAdapterImpl.INSTANCE.EnumLiteral_equalTo(library.BookCategory$Class.ScienceFiction, library.BookCategory$Class.Biography));
				// return result
		...
		public static Object inv$15(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t33 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
		...
		public static Object inv$16(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t36 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
		...
		public static Object inv$17(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t40 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
		...
		public static Object inv$18(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t44 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
				...
				// Call operation 'equalTo'
				OclBoolean t47 = StdLibAdapterImpl.INSTANCE.Boolean(KmfImplementationAdapterImpl.INSTANCE.EnumLiteral_equalTo(category, library.BookCategory$Class.Biography));
		...
		public static Object inv$19(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t51 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
				OclSequence t50 = (OclSequence)t51.asSequence();
				// Call operation 'first'
				library.Book t49 = (library.Book)t50.first();
				// Call property 'books'
				OclSequence t54 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
				OclSequence t53 = (OclSequence)t54.asSequence();
				// Call operation 'last'
				library.Book t52 = (library.Book)t53.last();
				// Call operation 'equalTo'
				OclBoolean t48 = StdLibAdapterImpl.INSTANCE.Boolean(KmfImplementationAdapterImpl.INSTANCE.OclModelElement_equalTo(t49, t52));
				// return result
		...
		public static Object inv$20(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t57 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
				...
				library.Book b1 = t55;
				// Call property 'books'
				OclSequence t60 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
				...
				library.Book b2 = t58;
				// Call operation 'equalTo'
				OclBoolean t61 = StdLibAdapterImpl.INSTANCE.Boolean(KmfImplementationAdapterImpl.INSTANCE.OclModelElement_equalTo(b1, b2));
				// return result
		...
		public static Object inv$21(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t64 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
				...
				library.Book b1 = t62;
				// Call property 'books'
				OclSequence t67 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
				...
				library.Book b2 = t65;
				// Call operation 'equalTo'
				OclBoolean t68 = StdLibAdapterImpl.INSTANCE.Boolean(KmfImplementationAdapterImpl.INSTANCE.OclModelElement_equalTo(b1, b2));
				// return result
		...
		public static Object inv$22(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t71 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'size'
		...
		public static Object inv$23(library.Library self) {
			try {
				// Call property 'books'
				OclSequence t76 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
				...
				// Call operation 'equalTo'
				OclBoolean t72 = StdLibAdapterImpl.INSTANCE.Boolean(KmfImplementationAdapterImpl.INSTANCE.EnumLiteral_equalTo(t73, library.BookCategory$Class.Biography));
				// return result
		...
		public static Object inv$24(library.Library self) {
			try {
				// 'any' iterator
				// Call property 'books'
				OclSequence t77 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				library.Book b = null;
				//--- Init result ---
		...
		public static Object inv$25(library.Library self) {
			try {
				// 'any' iterator
				// Call property 'books'
				OclSequence t84 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				library.Book b = null;
				//--- Init result ---
		...
		public static Object inv$26(library.Library self) {
			try {
				// 'any' iterator
				// Call property 'books'
				OclSequence t89 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				library.Book b = null;
				//--- Init result ---
		...
		public static Object inv$27(library.Library self) {
			try {
				// 'any' iterator
				// Call property 'books'
				OclSequence t95 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				library.Book b = null;
				//--- Init result ---
		...
		public static Object inv$28(library.Library self) {
			try {
				// 'any' iterator
				// Call property 'books'
				OclSequence t102 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				library.Book b = null;
				//--- Init result ---
				...
				// Call property 'books'
				OclSequence t109 = StdLibAdapterImpl.INSTANCE.Sequence(self.getBooks());
				// Call operation 'asSequence'
