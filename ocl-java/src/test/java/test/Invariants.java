...
import uk.ac.kent.cs.ocl20.bridge4java.*;
...
public class Invariants {
	public static class Library {
		...
		public static Object inv$9(library.Library self) {
			try {
				// return result
				if (library.BookCategory.ScienceFiction != null) return library.BookCategory.ScienceFiction;
				else return StdLibAdapterImpl.INSTANCE.Undefined();
			} catch (Exception e) {
				return StdLibAdapterImpl.INSTANCE.Undefined();
			}
		...
		public static Object inv$10(library.Library self) {
			try {
				// return result
				if (library.BookCategory.Biography != null) return library.BookCategory.Biography;
				else return StdLibAdapterImpl.INSTANCE.Undefined();
			} catch (Exception e) {
				return StdLibAdapterImpl.INSTANCE.Undefined();
			}
		...
		public static Object inv$11(library.Library self) {
			try {
				...
				OclBoolean t27 = StdLibAdapterImpl.INSTANCE.Boolean(JavaImplementationAdapter.INSTANCE.EnumLiteral_equalTo(library.BookCategory.ScienceFiction, library.BookCategory.ScienceFiction));
				// return result
		...
		public static Object inv$12(library.Library self) {
			try {
				// Call operation 'equalTo'
				OclBoolean t28 = StdLibAdapterImpl.INSTANCE.Boolean(JavaImplementationAdapter.INSTANCE.EnumLiteral_equalTo(library.BookCategory.ScienceFiction, library.BookCategory.Biography));
				// return result
		...
		public static Object inv$13(library.Library self) {
			try {
				...
				OclBoolean t29 = StdLibAdapterImpl.INSTANCE.Boolean(!JavaImplementationAdapter.INSTANCE.EnumLiteral_equalTo(library.BookCategory.ScienceFiction, library.BookCategory.ScienceFiction));
				// return result
		...
		public static Object inv$14(library.Library self) {
			try {
				// Call operation 'notEqualTo'
				OclBoolean t30 = StdLibAdapterImpl.INSTANCE.Boolean(!JavaImplementationAdapter.INSTANCE.EnumLiteral_equalTo(library.BookCategory.ScienceFiction, library.BookCategory.Biography));
				// return result
		...
		public static Object inv$18(library.Library self) {
			try {
				...
				// Call operation 'equalTo'
				OclBoolean t47 = StdLibAdapterImpl.INSTANCE.Boolean(JavaImplementationAdapter.INSTANCE.EnumLiteral_equalTo(category, library.BookCategory.Biography));
		...
		public static Object inv$19(library.Library self) {
			try {
				...
				// Call operation 'equalTo'
				OclBoolean t48 = StdLibAdapterImpl.INSTANCE.Boolean(JavaImplementationAdapter.INSTANCE.OclModelElement_equalTo(t49, t52));
				// return result
		...
		public static Object inv$20(library.Library self) {
			try {
				...
				library.Book b2 = t58;
				// Call operation 'equalTo'
				OclBoolean t61 = StdLibAdapterImpl.INSTANCE.Boolean(JavaImplementationAdapter.INSTANCE.OclModelElement_equalTo(b1, b2));
				// return result
		...
		public static Object inv$21(library.Library self) {
			try {
				...
				library.Book b2 = t65;
				// Call operation 'equalTo'
				OclBoolean t68 = StdLibAdapterImpl.INSTANCE.Boolean(JavaImplementationAdapter.INSTANCE.OclModelElement_equalTo(b1, b2));
				// return result
		...
		public static Object inv$23(library.Library self) {
			try {
				...
				// Call operation 'equalTo'
				OclBoolean t72 = StdLibAdapterImpl.INSTANCE.Boolean(JavaImplementationAdapter.INSTANCE.EnumLiteral_equalTo(t73, library.BookCategory.Biography));
				// return result
