...
public class TypeExp$Class
implements
    TypeExp,
    SemanticsVisitable
{
	/** Default constructor */
	public TypeExp$Class() {
	...
	public TypeExp$Class(String name, Boolean isMarkedPre, Classifier litType) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Clone the object */
	public Object clone() {
		TypeExp$Class obj = new TypeExp$Class();
