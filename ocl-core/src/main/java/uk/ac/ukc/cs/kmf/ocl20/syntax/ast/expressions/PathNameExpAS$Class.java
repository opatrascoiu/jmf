    ...
    uk.ac.ukc.cs.kmf.ocl20.syntax.SyntaxVisitable
{
	...
	public PathNameExpAS$Class(Boolean isMarkedPre, java.util.List pathName) {
		//--- Set property 'isMarkedPre' from 'OclExpressionAS' ---
	...
	public String toString() {
		String strId = "syntax.ast.expressions.PathNameExpAS";
		String name = null;
		try {
	...
	/** Accept 'uk.ac.ukc.cs.kmf.ocl20.syntax.ast.expressions.PathNameExpASVisitor' */
