 ...
 *
 */
public class EmfOclProcessorImpl
	extends OclProcessorImpl
	implements OclProcessor
{
	public EmfBridgeFactory bridgeFactory = new EmfBridgeFactory(this);
	...
	public ModelImplementationAdapter modelImplAdapter = new EmfImplementationAdapter();
	public ModelImplementationAdapter getModelImplAdapter() {return modelImplAdapter; }
	
	private StdLibAdapterImpl stdLibAdapter = new StdLibAdapterImpl();
	...
	public String getModelImplAdapterName() {return "EmfImplementationAdapter.INSTANCE"; }
	...
	public EmfOclProcessorImpl(Set models, ILog log) {
		super(models, log);
	}
	...
	public void generate(Reader input, PrintWriter output, String pkgName, ILog log) {
		try {
			...
			output.println("import uk.ac.kent.cs.ocl20.bridge4emf.*;");
			output.println();
