 ...
 *
 */
public class EmfImplementationAdapter
	implements ModelImplementationAdapter
{
	public static EmfImplementationAdapter INSTANCE = new EmfImplementationAdapter();
	...
	public String getEnumLiteralValue(String eenum, String enumLit) {
		return eenum+".get(\""+enumLit+"\")";
	}
	...
	public boolean OclModelElement_oclIsTypeOf(Object o1, Object o2) {
		...
		if (o1 instanceof OclAnyType) o1 = ((OclAnyType)o1).getImplClass();
		if (o2 instanceof OclAnyType) o2 = ((OclAnyType)o2).getImplClass(); 
