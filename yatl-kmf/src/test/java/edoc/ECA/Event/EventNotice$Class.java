...
public class EventNotice$Class
extends
	PubSubNotice$Class
implements
	EventNotice,
    edoc.EdocVisitable
{
	...
	public EventNotice$Class() {
		...
		//--- Set property 'describes' from 'EventNotice' ---
		this.describes = null;
		//--- Set property 'triggeredBy' from 'EventNotice' ---
		this.triggeredBy = null;
	}
	/** Specialized constructor */
	public EventNotice$Class(String name) {
		//--- Set property 'name' from 'PackageContent' ---
		this.name = name;
		//--- Set property 'namespace_' from 'PackageContent' ---
		this.namespace_ = null;
	...
	/** Property 'describes' from 'EventNotice' */
	protected BusinessEvent describes;
	/** Get property 'describes' from 'EventNotice' */
	...
	/** Property 'triggeredBy' from 'EventNotice' */
	protected BusinessEvent triggeredBy;
	/** Get property 'triggeredBy' from 'EventNotice' */
	...
	public String toString() {
		String strId = "edoc.ECA.Event.EventNotice";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (describes != null)
			this.describes.getDescribedBy().remove(this);
		if (triggeredBy != null)
			this.triggeredBy.getTriggers().remove(this);
	}

	/** Clone the object */
	public Object clone() {
		EventNotice$Class obj = new EventNotice$Class();
		...
		obj.describes = describes==null ? null : this.describes;
		obj.triggeredBy = triggeredBy==null ? null : this.triggeredBy;
		return obj;
	}
