/**
 *
 *  Class EventBasedDataManager$Class.java
 *
...
public class EventBasedDataManager$Class
implements
	EventBasedDataManager,
    edoc.EdocVisitable
{
	/** Default constructor */
	public EventBasedDataManager$Class() {
		...
		this.manages = null;
		//--- Set property 'dataEvents' from 'EventBasedDataManager' ---
		this.dataEvents = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public EventBasedDataManager$Class(String name, edoc.ECA.CCA.GranularityKind granularity, Boolean isPersistent, String primitiveKind, String primitiveSpec, Boolean networkAccess, Boolean shareable) {
		//--- Set property 'portsUsed' from 'UsageContext' ---
		this.portsUsed = new java.util.LinkedHashSet();
		//--- Set property 'bindings' from 'Composition' ---
		this.bindings = new java.util.LinkedHashSet();
	...
	/** Property 'dataEvents' from 'EventBasedDataManager' */
	protected java.util.Set dataEvents;
	/** Get property 'dataEvents' from 'EventBasedDataManager' */
	...
	public String toString() {
		String strId = "edoc.ECA.Event.EventBasedDataManager";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator dataEventsIt = this.dataEvents.iterator();
		while (dataEventsIt.hasNext()) {
			edoc.ECA.Event.DataEvent dataEventsObj = (edoc.ECA.Event.DataEvent)dataEventsIt.next();
			if (dataEventsObj != null)
				dataEventsObj.setEventContext(null);
		}
	}

	/** Clone the object */
	public Object clone() {
		EventBasedDataManager$Class obj = new EventBasedDataManager$Class();
		...
		obj.dataEvents = dataEvents==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.dataEvents).clone();
		return obj;
	}
