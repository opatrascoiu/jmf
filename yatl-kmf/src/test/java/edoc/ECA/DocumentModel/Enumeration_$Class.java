    ...
    edoc.EdocVisitable
{
	...
	public Enumeration_$Class() {
		...
		//--- Set property 'values' from 'Enumeration_' ---
		this.values = new java.util.LinkedHashSet();
		//--- Set property 'initial' from 'Enumeration_' ---
		this.initial = null;
	}
	/** Specialized constructor */
	public Enumeration_$Class(String name) {
		//--- Set property 'name' from 'PackageContent' ---
		this.name = name;
		//--- Set property 'namespace_' from 'PackageContent' ---
		this.namespace_ = null;
	...
	/** Property 'values' from 'Enumeration_' */
	protected java.util.Set values;
	/** Get property 'values' from 'Enumeration_' */
	...
	/** Property 'initial' from 'Enumeration_' */
	protected EnumerationValue initial;
	/** Get property 'initial' from 'Enumeration_' */
	...
	public String toString() {
		String strId = "edoc.ECA.DocumentModel.Enumeration_";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator valuesIt = this.values.iterator();
		while (valuesIt.hasNext()) {
			edoc.ECA.DocumentModel.EnumerationValue valuesObj = (edoc.ECA.DocumentModel.EnumerationValue)valuesIt.next();
			if (valuesObj != null)
				valuesObj.setEnumeration(null);
		}
		if (initial != null)
			this.initial.setInitialFor(null);
	}
	...
	public Object clone() {
		...
		obj.values = values==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.values).clone();
