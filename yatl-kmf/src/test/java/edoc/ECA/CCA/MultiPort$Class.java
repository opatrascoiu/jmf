...
public class MultiPort$Class
implements
	MultiPort,
    edoc.EdocVisitable
{
	/** Default constructor */
	public MultiPort$Class() {
	...
	public MultiPort$Class(String name, Boolean isSynchronous, Boolean isTransactional, DirectionType direction, Status postCondition) {
		//--- Set property 'name' from 'Port' ---
		this.name = name;
		//--- Set property 'isSynchronous' from 'Port' ---
	...
	public String toString() {
		String strId = "edoc.ECA.CCA.MultiPort";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		MultiPort$Class obj = new MultiPort$Class();
