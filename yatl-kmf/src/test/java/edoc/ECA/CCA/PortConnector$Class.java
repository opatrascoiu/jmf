/**
 *
 *  Class PortConnector$Class.java
 *
...
public class PortConnector$Class
implements
	PortConnector,
    edoc.EdocVisitable
{
	/** Default constructor */
	public PortConnector$Class() {
	...
	public PortConnector$Class(String name) {
		//--- Set property 'name' from 'Node' ---
		this.name = name;
		//--- Set property 'owner' from 'Node' ---
		this.owner = null;
	...
	public String toString() {
		String strId = "edoc.ECA.CCA.PortConnector";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		PortConnector$Class obj = new PortConnector$Class();
