/**
 *
 *  Class ProcessComponent$Class.java
 *
...
public class ProcessComponent$Class
implements
	ProcessComponent,
    edoc.EdocVisitable
{
	/** Default constructor */
	public ProcessComponent$Class() {
	...
	public ProcessComponent$Class(String name, GranularityKind granularity, Boolean isPersistent, String primitiveKind, String primitiveSpec) {
		//--- Set property 'nodes' from 'Choreography' ---
		this.nodes = new java.util.LinkedHashSet();
		//--- Set property 'connections' from 'Choreography' ---
		this.connections = new java.util.LinkedHashSet();
	...
	protected GranularityKind granularity;
	...
	public String toString() {
		String strId = "edoc.ECA.CCA.ProcessComponent";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		ProcessComponent$Class obj = new ProcessComponent$Class();
		...
		obj.granularity = granularity==null ? null : (GranularityKind)this.granularity.clone();
