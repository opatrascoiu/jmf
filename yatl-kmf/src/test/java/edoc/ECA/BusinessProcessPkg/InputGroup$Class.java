    ...
    edoc.EdocVisitable
{
	...
	public InputGroup$Class(String name, Boolean isSynchronous, Boolean isTransactional, edoc.ECA.CCA.DirectionType direction, edoc.ECA.CCA.Status postCondition) {
		//--- Set property 'name' from 'Port' ---
		this.name = name;
		//--- Set property 'isSynchronous' from 'Port' ---
	...
	public String toString() {
		String strId = "edoc.ECA.BusinessProcessPkg.InputGroup";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		InputGroup$Class obj = new InputGroup$Class();
