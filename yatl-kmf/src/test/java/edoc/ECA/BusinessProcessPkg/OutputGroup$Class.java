...
public class OutputGroup$Class
extends
	ProcessMultiPort$Class
implements
	OutputGroup,
    edoc.EdocVisitable
{
	/** Default constructor */
	public OutputGroup$Class() {
	...
	public OutputGroup$Class(String name, Boolean isSynchronous, Boolean isTransactional, edoc.ECA.CCA.DirectionType direction, edoc.ECA.CCA.Status postCondition) {
		//--- Set property 'name' from 'Port' ---
		this.name = name;
		//--- Set property 'isSynchronous' from 'Port' ---
	...
	public String toString() {
		String strId = "edoc.ECA.BusinessProcessPkg.OutputGroup";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		OutputGroup$Class obj = new OutputGroup$Class();
