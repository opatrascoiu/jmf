    ...
    edoc.EdocVisitable
{
	...
	public BusinessProcess$Class(String name, edoc.ECA.CCA.GranularityKind granularity, Boolean isPersistent, String primitiveKind, String primitiveSpec) {
		//--- Set property 'nodes' from 'Choreography' ---
		this.nodes = new java.util.LinkedHashSet();
		//--- Set property 'connections' from 'Choreography' ---
		this.connections = new java.util.LinkedHashSet();
	...
	public String toString() {
		String strId = "edoc.ECA.BusinessProcessPkg.BusinessProcess";
		String name = null;
		try {
