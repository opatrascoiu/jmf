/**
 *
 *  Class ResponsibleParty$Class.java
 *
...
public class ResponsibleParty$Class
extends
	ProcessRole$Class
implements
	ResponsibleParty,
    edoc.EdocVisitable
{
	...
	public ResponsibleParty$Class(String name, String selectionRule, String creationRule) {
		//--- Set property 'portsUsed' from 'UsageContext' ---
		this.portsUsed = new java.util.LinkedHashSet();
		//--- Set property 'name' from 'ComponentUsage' ---
		this.name = name;
	...
	public String toString() {
		String strId = "edoc.ECA.BusinessProcessPkg.ResponsibleParty";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		ResponsibleParty$Class obj = new ResponsibleParty$Class();
