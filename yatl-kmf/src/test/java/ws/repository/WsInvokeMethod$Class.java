/**
 *
 *  Class WsInvokeMethod$Class.java
 *
	 ...
	 extends JInternalFrame
{
	...
	/** Construct invoker */
	public WsInvokeMethod$Class(ws.repository.WsRepository rep, ws.repository.WsBrowser$Class brow, Object instance, Method method) {
		//--- Init members ---
		this.brow = brow;
		this.rep = rep;
		...
		if (types.length != 0) {
			...
			//--- Preferred sizes ---
			Dimension listSize = ws.repository.WsBrowser$Class.listSize;
			Dimension fieldSize = ws.repository.WsBrowser$Class.fieldSize;
			...
			for(int i=0; i<types.length; i++) {
				...
				if (typeName.endsWith("Boolean") || typeName.endsWith("Integer") || typeName.endsWith("Real") || 
					...
					values[i].setFont(ws.repository.WsBrowser$Class.font);
