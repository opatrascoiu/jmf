    ...
    ws.WsVisitable
{
	...
	public Scope$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure, Boolean variableAccessSerializable) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	/** Clone the object */
	public Object clone() {
		Scope$Class obj = new Scope$Class();
