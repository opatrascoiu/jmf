    ...
    ws.WsVisitable
{
	...
	public Assign$Class() {
		...
		this.catch_ = null;
		//--- Set property 'copy' from 'Assign' ---
		this.copy = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Assign$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	/** Property 'copy' from 'Assign' */
	protected java.util.Set copy;
	/** Get property 'copy' from 'Assign' */
	...
	public void delete() {
		...
		java.util.Iterator copyIt = this.copy.iterator();
		while (copyIt.hasNext()) {
			ws.bpel.Copy copyObj = (ws.bpel.Copy)copyIt.next();
			if (copyObj != null)
				copyObj.setAssign(null);
		}
	}

	/** Clone the object */
	public Object clone() {
		Assign$Class obj = new Assign$Class();
		...
		obj.copy = copy==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.copy).clone();
		return obj;
	}
