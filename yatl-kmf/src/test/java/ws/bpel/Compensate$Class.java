...
public class Compensate$Class
implements
	Compensate,
    ws.WsVisitable
{
	/** Default constructor */
	public Compensate$Class() {
	...
	public Compensate$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	public String toString() {
		String strId = "ws.bpel.Compensate";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		Compensate$Class obj = new Compensate$Class();
