    ...
    ws.WsVisitable
{
	...
	public Switch$Class() {
		...
		this.activity = null;
		//--- Set property 'otherwise' from 'Switch' ---
		this.otherwise = null;
		//--- Set property 'cases' from 'Switch' ---
		this.cases = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Switch$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	/** Property 'otherwise' from 'Switch' */
	protected Activity otherwise;
	/** Get property 'otherwise' from 'Switch' */
	...
	/** Property 'cases' from 'Switch' */
	protected java.util.Set cases;
	/** Get property 'cases' from 'Switch' */
	...
	public void delete() {
		...
		if (otherwise != null)
			this.otherwise.setSwitch_(null);
		java.util.Iterator casesIt = this.cases.iterator();
		while (casesIt.hasNext()) {
			ws.bpel.Case casesObj = (ws.bpel.Case)casesIt.next();
			if (casesObj != null)
				casesObj.setSwitch_(null);
		}
	}

	/** Clone the object */
	public Object clone() {
		Switch$Class obj = new Switch$Class();
		...
		obj.otherwise = otherwise==null ? null : this.otherwise;
		obj.cases = cases==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.cases).clone();
		return obj;
	}
