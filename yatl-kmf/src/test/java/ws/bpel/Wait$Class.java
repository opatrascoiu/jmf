    ...
    ws.WsVisitable
{
	...
	public Wait$Class() {
		...
		this.catch_ = null;
		//--- Set property 'durationKind' from 'Wait' ---
		this.durationKind = null;
		//--- Set property 'expression' from 'Wait' ---
		this.expression = null;
	}
	/** Specialized constructor */
	public Wait$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure, DurationKind durationKind) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	/** Property 'durationKind' from 'Wait' */
	protected DurationKind durationKind;
	/** Get property 'durationKind' from 'Wait' */
	...
	/** Property 'expression' from 'Wait' */
	protected Expression expression;
	/** Get property 'expression' from 'Wait' */
	...
	public void delete() {
		...
		if (expression != null)
			this.expression.setWait(null);
	}

	/** Clone the object */
	public Object clone() {
		Wait$Class obj = new Wait$Class();
