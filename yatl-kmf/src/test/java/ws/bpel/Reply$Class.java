    ...
    ws.WsVisitable
{
	...
	public Reply$Class() {
		...
		this.operation = null;
		//--- Set property 'faultName' from 'Reply' ---
		this.faultName = null;
		//--- Set property 'variable' from 'Reply' ---
		this.variable = null;
	}
	/** Specialized constructor */
	public Reply$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure, String faultName) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	/** Property 'faultName' from 'Reply' */
	protected String faultName;
	/** Get property 'faultName' from 'Reply' */
	...
	/** Property 'variable' from 'Reply' */
	protected Variable variable;
	/** Get property 'variable' from 'Reply' */
	...
	public void delete() {
		...
		if (variable != null)
			this.variable.setReply(null);
	}

	/** Clone the object */
	public Object clone() {
		Reply$Class obj = new Reply$Class();
