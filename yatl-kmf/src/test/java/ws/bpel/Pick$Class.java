    ...
    ws.WsVisitable
{
	...
	public Pick$Class() {
		...
		this.activity = null;
		//--- Set property 'createInstance' from 'Pick' ---
		this.createInstance = null;
		//--- Set property 'onMessages' from 'Pick' ---
		this.onMessages = new java.util.LinkedHashSet();
		//--- Set property 'onAlarms' from 'Pick' ---
		this.onAlarms = new java.util.LinkedHashSet();
	}
	/** Specialized constructor */
	public Pick$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure, Boolean createInstance) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	/** Property 'createInstance' from 'Pick' */
	protected Boolean createInstance;
	/** Get property 'createInstance' from 'Pick' */
	...
	/** Property 'onMessages' from 'Pick' */
	protected java.util.Set onMessages;
	/** Get property 'onMessages' from 'Pick' */
	...
	/** Property 'onAlarms' from 'Pick' */
	protected java.util.Set onAlarms;
	/** Get property 'onAlarms' from 'Pick' */
	...
	public void delete() {
		...
		java.util.Iterator onMessagesIt = this.onMessages.iterator();
		while (onMessagesIt.hasNext()) {
			ws.bpel.OnMessage onMessagesObj = (ws.bpel.OnMessage)onMessagesIt.next();
			if (onMessagesObj != null)
				onMessagesObj.setPick(null);
		}
		java.util.Iterator onAlarmsIt = this.onAlarms.iterator();
		while (onAlarmsIt.hasNext()) {
			ws.bpel.OnAlarm onAlarmsObj = (ws.bpel.OnAlarm)onAlarmsIt.next();
			if (onAlarmsObj != null)
				onAlarmsObj.setPick(null);
		}
	}

	/** Clone the object */
	public Object clone() {
		Pick$Class obj = new Pick$Class();
		...
		obj.onMessages = onMessages==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.onMessages).clone();
		obj.onAlarms = onAlarms==null ? null : (java.util.Set)((java.util.LinkedHashSet)this.onAlarms).clone();
		return obj;
	}
