...
public class FromVariable$Class
implements
	FromVariable,
    ws.WsVisitable
{
	/** Default constructor */
	public FromVariable$Class() {
	...
	public String toString() {
		String strId = "ws.bpel.FromVariable";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		FromVariable$Class obj = new FromVariable$Class();
