...
public class Terminate$Class
implements
	Terminate,
    ws.WsVisitable
{
	/** Default constructor */
	public Terminate$Class() {
	...
	public Terminate$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	public String toString() {
		String strId = "ws.bpel.Terminate";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		Terminate$Class obj = new Terminate$Class();
