/**
 *
 *  Class ActivitySequence$Class.java
 *
...
public class ActivitySequence$Class
implements
	ActivitySequence,
    ws.WsVisitable
{
	/** Default constructor */
	public ActivitySequence$Class() {
		...
		this.activity = null;
		//--- Set property 'body' from 'ActivitySequence' ---
		this.body = new java.util.Vector();
	}
	/** Specialized constructor */
	public ActivitySequence$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	/** Property 'body' from 'ActivitySequence' */
	protected java.util.List body;
	/** Get property 'body' from 'ActivitySequence' */
	...
	public String toString() {
		String strId = "ws.bpel.ActivitySequence";
		String name = null;
		try {
	...
	public void delete() {
		...
		java.util.Iterator bodyIt = this.body.iterator();
		while (bodyIt.hasNext()) {
			ws.bpel.Activity bodyObj = (ws.bpel.Activity)bodyIt.next();
			if (bodyObj != null)
				bodyObj.setActivitySequence(null);
		}
	}

	/** Clone the object */
	public Object clone() {
		ActivitySequence$Class obj = new ActivitySequence$Class();
		...
		obj.body = body==null ? null : (java.util.List)((java.util.Vector)this.body).clone();
		return obj;
	}
