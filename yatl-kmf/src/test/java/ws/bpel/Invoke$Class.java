    ...
    ws.WsVisitable
{
	...
	public Invoke$Class() {
		...
		this.operation = null;
		//--- Set property 'inputVariable' from 'Invoke' ---
		this.inputVariable = null;
		//--- Set property 'outputVariable' from 'Invoke' ---
		this.outputVariable = null;
		//--- Set property 'invokeFaultHandler' from 'Invoke' ---
		this.invokeFaultHandler = null;
		//--- Set property 'compensationHandler' from 'Invoke' ---
		this.compensationHandler = null;
	}
	/** Specialized constructor */
	public Invoke$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	/** Property 'inputVariable' from 'Invoke' */
	protected Variable inputVariable;
	/** Get property 'inputVariable' from 'Invoke' */
	...
	/** Property 'outputVariable' from 'Invoke' */
	protected Variable outputVariable;
	/** Get property 'outputVariable' from 'Invoke' */
	...
	/** Property 'invokeFaultHandler' from 'Invoke' */
	protected FaultHandler invokeFaultHandler;
	/** Get property 'invokeFaultHandler' from 'Invoke' */
	public FaultHandler getInvokeFaultHandler() {
		return invokeFaultHandler;
	}
	/** Set property 'invokeFaultHandler' from 'Invoke' */
	public void setInvokeFaultHandler(FaultHandler invokeFaultHandler) { 
		this.invokeFaultHandler = invokeFaultHandler;
	}

	/** Property 'compensationHandler' from 'Invoke' */
	protected Activity compensationHandler;
	/** Get property 'compensationHandler' from 'Invoke' */
	...
	public void delete() {
		...
		if (inputVariable != null)
			this.inputVariable.setInputInvoke(null);
		if (outputVariable != null)
			this.outputVariable.setOutputInvoke(null);
		if (invokeFaultHandler != null)
			this.invokeFaultHandler.setInvoke(null);
		if (compensationHandler != null)
			this.compensationHandler.setInvoke(null);
	}

	/** Clone the object */
	public Object clone() {
		Invoke$Class obj = new Invoke$Class();
		...
		obj.inputVariable = inputVariable==null ? null : this.inputVariable;
		obj.outputVariable = outputVariable==null ? null : this.outputVariable;
		obj.invokeFaultHandler = invokeFaultHandler==null ? null : this.invokeFaultHandler;
		obj.compensationHandler = compensationHandler==null ? null : this.compensationHandler;
		return obj;
	}

	/** Accept 'ws.bpel.InvokeVisitor' */
