    ...
    ws.WsVisitable
{
	...
	public While$Class() {
		...
		this.activity = null;
		//--- Set property 'body' from 'While' ---
		this.body = null;
		//--- Set property 'condition' from 'While' ---
		this.condition = null;
	}
	/** Specialized constructor */
	public While$Class(String name, BooleanExpression joinCondition, Boolean suppressJoinFailure) {
		//--- Set property 'name' from 'Activity' ---
		this.name = name;
		//--- Set property 'joinCondition' from 'Activity' ---
	...
	/** Property 'body' from 'While' */
	protected Activity body;
	/** Get property 'body' from 'While' */
	...
	/** Property 'condition' from 'While' */
	protected BooleanExpression condition;
	/** Get property 'condition' from 'While' */
	...
	public void delete() {
		...
		if (body != null)
			this.body.setWhile_(null);
		if (condition != null)
			this.condition.setWhile_(null);
	}

	/** Clone the object */
	public Object clone() {
		While$Class obj = new While$Class();
