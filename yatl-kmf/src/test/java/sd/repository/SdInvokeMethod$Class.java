/**
 *
 *  Class SdInvokeMethod$Class.java
 *
	 ...
	 extends JInternalFrame
{
	...
	/** Construct invoker */
	public SdInvokeMethod$Class(sd.repository.SdRepository rep, sd.repository.SdBrowser$Class brow, Object instance, Method method) {
		//--- Init members ---
		this.brow = brow;
		this.rep = rep;
		...
		if (types.length != 0) {
			...
			//--- Preferred sizes ---
			Dimension listSize = sd.repository.SdBrowser$Class.listSize;
			Dimension fieldSize = sd.repository.SdBrowser$Class.fieldSize;
			...
			for(int i=0; i<types.length; i++) {
				...
				if (typeName.endsWith("Boolean") || typeName.endsWith("Integer") || typeName.endsWith("Real") || 
					...
					values[i].setFont(sd.repository.SdBrowser$Class.font);
