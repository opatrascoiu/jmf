...
public class NotCompound$Class
extends
    ...
    sd.SdVisitable
{
	...
	public NotCompound$Class(String name) {
		//--- Set property 'name' from 'Diagram' ---
		this.name = name;
		//--- Set property 'compoundDiagram' from 'Diagram' ---
		this.compoundDiagram = null;
	...
	public String toString() {
		String strId = "sd.as.NotCompound";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		NotCompound$Class obj = new NotCompound$Class();
