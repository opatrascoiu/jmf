    ...
    sd.SdVisitable
{
	...
	public OrCompound$Class(String name) {
		//--- Set property 'name' from 'Diagram' ---
		this.name = name;
		//--- Set property 'compoundDiagram' from 'Diagram' ---
		this.compoundDiagram = null;
	...
	/** Clone the object */
	public Object clone() {
		OrCompound$Class obj = new OrCompound$Class();
