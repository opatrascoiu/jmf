...
public class FalseDiagram$Class
extends
    ...
    sd.SdVisitable
{
	...
	public FalseDiagram$Class(String name) {
		//--- Set property 'name' from 'Diagram' ---
		this.name = name;
		//--- Set property 'compoundDiagram' from 'Diagram' ---
		this.compoundDiagram = null;
	...
	public String toString() {
		String strId = "sd.as.FalseDiagram";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		FalseDiagram$Class obj = new FalseDiagram$Class();
