/**
 *
 *  Class CompoundDiagram$Class.java
 *
...
public class CompoundDiagram$Class
extends
	Diagram$Class
implements
	CompoundDiagram,
    sd.SdVisitable
{
	...
	public CompoundDiagram$Class(String name) {
		//--- Set property 'name' from 'Diagram' ---
		this.name = name;
		//--- Set property 'compoundDiagram' from 'Diagram' ---
		this.compoundDiagram = null;
	...
	/** Property 'children' from 'CompoundDiagram' */
	protected java.util.List children;
	/** Get property 'children' from 'CompoundDiagram' */
	...
	/** Property 'unitaryParts' from 'CompoundDiagram' */
	protected java.util.List unitaryParts;
	/** Get property 'unitaryParts' from 'CompoundDiagram' */
	public java.util.List getUnitaryParts() {
		return unitaryParts;
	}
	/** Set property 'unitaryParts' from 'CompoundDiagram' */
	public void setUnitaryParts(java.util.List unitaryParts) { 
		this.unitaryParts = unitaryParts;
	}
	...
	public String toString() {
		String strId = "sd.as.CompoundDiagram";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		CompoundDiagram$Class obj = new CompoundDiagram$Class();
