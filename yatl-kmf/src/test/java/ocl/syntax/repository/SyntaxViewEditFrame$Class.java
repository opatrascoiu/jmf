/**
 *
 *  Class SyntaxViewEditFrame$Class.java
 *
...
public class SyntaxViewEditFrame$Class
	extends JInternalFrame
{
	...
	public SyntaxViewEditFrame$Class(Object host, ocl.syntax.repository.SyntaxRepository rep) {
		//--- Frame settings ---
