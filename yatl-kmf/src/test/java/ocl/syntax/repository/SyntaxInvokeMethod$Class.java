/**
 *
 *  Class SyntaxInvokeMethod$Class.java
 *
	 ...
	 extends JInternalFrame
{
	...
	/** Construct invoker */
	public SyntaxInvokeMethod$Class(ocl.syntax.repository.SyntaxRepository rep, ocl.syntax.repository.SyntaxBrowser$Class brow, Object instance, Method method) {
		//--- Init members ---
		this.brow = brow;
		this.rep = rep;
		...
		if (types.length != 0) {
			...
			//--- Preferred sizes ---
			Dimension listSize = ocl.syntax.repository.SyntaxBrowser$Class.listSize;
			Dimension fieldSize = ocl.syntax.repository.SyntaxBrowser$Class.fieldSize;
			...
			for(int i=0; i<types.length; i++) {
				...
				if (typeName.endsWith("Boolean") || typeName.endsWith("Integer") || typeName.endsWith("Real") || 
					...
					values[i].setFont(ocl.syntax.repository.SyntaxBrowser$Class.font);
