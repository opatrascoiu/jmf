/**
 *
 *  Class SyntaxReaderAdapter$Class.java
 *
...
/**
  ...
  */
public class SyntaxReaderAdapter$Class
	...
	implements IReaderAdapter
{
	...
	/** Abstract factory */
	public SyntaxReaderAdapter$Class(ocl.syntax.repository.SyntaxRepository rep, ILog log) {
		this.rep = rep;
		this.log = log;
	}
