...
public class NotExpAS$Class
implements
	NotExpAS,
    ocl.syntax.SyntaxVisitable
{
	/** Default constructor */
	public NotExpAS$Class() {
	...
	public NotExpAS$Class(Boolean isMarkedPre) {
		//--- Set property 'isMarkedPre' from 'OclExpressionAS' ---
	...
	public String toString() {
		String strId = "syntax.ast.expressions.NotExpAS";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		NotExpAS$Class obj = new NotExpAS$Class();
