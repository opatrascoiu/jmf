...
public class XorExpAS$Class
implements
	XorExpAS,
    ocl.syntax.SyntaxVisitable
{
	/** Default constructor */
	public XorExpAS$Class() {
	...
	public XorExpAS$Class(Boolean isMarkedPre) {
		//--- Set property 'isMarkedPre' from 'OclExpressionAS' ---
	...
	public String toString() {
		String strId = "syntax.ast.expressions.XorExpAS";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (leftOperand != null)
			this.leftOperand.setLeftOperandSource(null);
		if (rightOperand != null)
			this.rightOperand.setRightOperandSource(null);
	}

	/** Clone the object */
	public Object clone() {
		XorExpAS$Class obj = new XorExpAS$Class();
	...
	/** Accept 'ocl.syntax.ast.expressions.XorExpASVisitor' */
