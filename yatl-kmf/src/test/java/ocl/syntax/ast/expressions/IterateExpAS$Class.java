    ...
    ocl.syntax.SyntaxVisitable
{
	...
	public IterateExpAS$Class() {
		...
		//--- Set property 'loopBody' from 'LoopExpAS' ---
		this.loopBody = null;
	...
	/** Property 'loopBody' from 'LoopExpAS' */
	protected OclExpressionAS loopBody;
	/** Get property 'loopBody' from 'LoopExpAS' */
	...
	protected ocl.syntax.ast.contexts.VariableDeclarationAS iterator;
	...
	protected ocl.syntax.ast.contexts.VariableDeclarationAS result;
	...
	public String toString() {
		String strId = "syntax.ast.expressions.IterateExpAS";
		String name = null;
		try {
	...
	public void delete() {
		...
		if (loopBody != null)
			this.loopBody.setBodyLoop(null);
		if (iterator != null)
			this.iterator.setIteratorLoop(null);
		if (result != null)
			this.result.setResultLoop(null);
		if (source != null)
			this.source.setSourceLoop(null);
	}
	...
	public Object clone() {
		...
		obj.loopBody = loopBody==null ? null : this.loopBody;
