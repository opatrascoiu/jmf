    ...
    ocl.syntax.SyntaxVisitable
{
	...
	public void delete() {
		...
		if (target != null)
			this.target.setOclMessageExpAS(null);
		java.util.Iterator argumentsIt = this.arguments.iterator();
		while (argumentsIt.hasNext()) {
			ocl.syntax.ast.expressions.OclMessageArgAS argumentsObj = (ocl.syntax.ast.expressions.OclMessageArgAS)argumentsIt.next();
			if (argumentsObj != null)
				argumentsObj.setOclMessageExpAS(null);
		}
	}
