/**
 *
 *  Class AssociationCallExpAS$Class.java
 *
...
public class AssociationCallExpAS$Class
implements
	AssociationCallExpAS,
    ocl.syntax.SyntaxVisitable
{
	/** Default constructor */
	public AssociationCallExpAS$Class() {
	...
	public AssociationCallExpAS$Class(Boolean isMarkedPre) {
		//--- Set property 'isMarkedPre' from 'OclExpressionAS' ---
	...
	public String toString() {
		String strId = "syntax.ast.expressions.AssociationCallExpAS";
		String name = null;
		try {
	...
	/** Clone the object */
	public Object clone() {
		AssociationCallExpAS$Class obj = new AssociationCallExpAS$Class();
