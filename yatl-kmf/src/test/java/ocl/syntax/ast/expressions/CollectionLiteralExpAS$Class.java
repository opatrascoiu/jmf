    ...
    ocl.syntax.SyntaxVisitable
{
	...
	public void delete() {
		...
		java.util.Iterator collectionPartsIt = this.collectionParts.iterator();
		while (collectionPartsIt.hasNext()) {
			ocl.syntax.ast.expressions.CollectionLiteralPartAS collectionPartsObj = (ocl.syntax.ast.expressions.CollectionLiteralPartAS)collectionPartsIt.next();
			if (collectionPartsObj != null)
				collectionPartsObj.setCollectionLiteralExpAS(null);
		}
	}
