    ...
    ocl.syntax.SyntaxVisitable
{
	...
	public void delete() {
		...
		java.util.Iterator tuplePartsIt = this.tupleParts.iterator();
		while (tuplePartsIt.hasNext()) {
			ocl.syntax.ast.contexts.VariableDeclarationAS tuplePartsObj = (ocl.syntax.ast.contexts.VariableDeclarationAS)tuplePartsIt.next();
			if (tuplePartsObj != null)
				tuplePartsObj.setTupleLiteralExpAS(null);
		}
	}
