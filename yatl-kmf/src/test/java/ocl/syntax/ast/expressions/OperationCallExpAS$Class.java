    ...
    ocl.syntax.SyntaxVisitable
{
	...
	public void delete() {
		...
		java.util.Iterator argumentsIt = this.arguments.iterator();
		while (argumentsIt.hasNext()) {
			ocl.syntax.ast.expressions.OclExpressionAS argumentsObj = (ocl.syntax.ast.expressions.OclExpressionAS)argumentsIt.next();
			if (argumentsObj != null)
				argumentsObj.setCallArguments(null);
		}
		if (source != null)
			this.source.setCallSource(null);
	}
