/**
 *
 *  Class JavaModelReaderAdapter$Class.java
 *
...
/**
  ...
  */
public class JavaModelReaderAdapter$Class
	...
	implements IReaderAdapter
{
	...
	/** Abstract factory */
	public JavaModelReaderAdapter$Class(javaModel.repository.JavaModelRepository rep, ILog log) {
		this.rep = rep;
		this.log = log;
	}
