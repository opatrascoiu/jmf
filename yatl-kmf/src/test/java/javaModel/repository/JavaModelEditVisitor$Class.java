/**
 *
 *  Class JavaModelEditVisitor$Class.java
 *
...
public class JavaModelEditVisitor$Class
	implements JavaModelEditVisitor
{
	/** Constructor */
	public JavaModelEditVisitor$Class(OclProcessor oclProcessor) {
